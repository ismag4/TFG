...
encabezado_m = "h_media\th_err\tomega_m\tomega_m_err\tw\tw_err\tomega_lambda\tomega_lambda_err"
val_medios_err = np.array([h_media, h_er, om_media, om_er, w_media,
                           w_er, ol_media, ol_er])
np.savetxt("wcdm_pr_val_medios.txt", val_medios_err, fmt='%.16f',
